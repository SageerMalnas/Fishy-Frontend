...
//     navigation.navigate('Cart', { cartItems, updateCartItems: setCartItems, removeCartItem, route });
...
//           <Ionicons name="cart-outline" size={30} color="#1d3557" />
//         </TouchableOpacity>
//         <TouchableOpacity onPress={() => navigation.navigate('Wishlist', { wishlistItems })} style={styles.wishlistIcon}>
//           <Ionicons name="heart-outline" size={30} color="#1d3557" />
//         </TouchableOpacity>
//       </View>
...
//     fontSize: 18,
//     fontWeight: 'bold',
//     color: '#1d3557', // Set title color to #506afa
//   },
//   tagline: {
//     fontSize: 11,
//     color: 'grey',
...
const FishEcomScreen = ({ navigation }) => {
  ...
  const openCartItems = () => {
    // Navigate to the cart screen
    navigation.navigate('Cart', { cartItems, updateCartItems: setCartItems, removeFromCart });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.iconContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Wishlist', { wishlistItems, updatedWishlistItems: setWishlistItems, removeFromWishlist })} style={styles.wishlistIcon}>
          <Ionicons name="heart-outline" size={30} color="#1d3557" />
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalPrice}>₹ {selectedProduct?.price}</Text>
            <Text style={styles.cashback}>
              FREE Delivery by {selectedProduct?.deliveryBy}
            </Text>
            <View style={styles.modalButtonsContainer}>
              <TouchableOpacity style={styles.button} onPress={() => addToCart(selectedProduct)}>
...
const styles = StyleSheet.create({
  ...
  modalButtonsContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    marginTop: 20, // Add margin to separate from other content
  },
  button: {
    backgroundColor: '#1d3557',
    padding: 10,
